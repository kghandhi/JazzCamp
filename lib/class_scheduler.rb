...
class ClassScheduler
  ...
  def run(args)
    ...
    camp = Camp.new(camp_name, human_readable)
  ...
  def _usage
    ...
    optional_arguments = "readable[optional]"
    @output.puts "ruby lib/class_scheduler.rb #{expected_arguments} #{optional_arguments}"
    @output.puts
